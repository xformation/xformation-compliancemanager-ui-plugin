...
export class EditRemediationPopup extends React.Component<any, any> {
        ...
        return (
            <Modal isOpen={state.modal} toggle={this.toggle} className="modal-container assessments-modal-container">
                ...
                <ModalBody style={{ height: 'calc(74vh - 110px)', overflowY: 'auto', overflowX: "hidden" }}>
                    ...
                    <div className="form-group">
                        <input type="checkbox" className="checkbox" onChange={(e) => { this.onChangeOpenRuleData(e) }} checked={this.state.Rule} /> Excluded by Rule
                        {this.state.Rule == true && <div className="d-block select-rule">
